...
/**
 * De goedkeuringsregel per groep — QS8-65 (PRD 6.4), migratie 0110.
 *
 ...
 *    (`trek_goedkeuring_in`, die vóór 0110 `nog_geldig > 0` deed). Zouden die
...
describe.skipIf(!rlsTestsConfigured)('QS8-65 — de goedkeuringsdrempel', () => {
   ...
   *    hier iets, dan heeft 0110 de bestaande goedkeuring gebroken voor iedereen.
   */
  it(
  ...
  /**
   * ⚠️ **De naad.** `trek_goedkeuring_in()` deed tot 0110 `nog_geldig > 0` — een
