/**
 * De Lijst staat dicht — QS8-379, migratie 0214.
 *
...
/** Zoals in 0214. Staat hier als spiegel; de laatste tests toetsen het gedrag. */
  ...
  describe('een groepsgenoot komt er niet bij', () => {
    ...
    it(
      ...
      async () => {
        ...
        // ⚠️ **Nul rijen én geen fout**, en dat is de stand die 0214 belooft: RLS
