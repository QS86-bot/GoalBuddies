/**
 * De huddledag is een afspraak en geen schakelaar — QS8-360, migratie 0205.
 *
 ...
 *
 * ⚠️ 📏 **Wat er gemeten is vóór 0205** — beschermde groep, huddledag zondag,
  ...
  for (const stand of ['beschermd', 'open'] as const) {
    it(
      ...
      async () => {
        ...
        //    kon vóór 0205 nooit meer landen; nu wel, op de nieuwe start.
