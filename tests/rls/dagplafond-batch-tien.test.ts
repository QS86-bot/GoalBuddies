 ...
 *    issue.** Er zat een plafond van 100 in de eerste versie van 0203. 📏 Maar
 ...
 *    raken. Het plafond is eruit; de meting staat in 0203.
 *
...
describe.runIf(rlsTestsConfigured)('het dagplafond op de zes tabellen van QS8-344', () => {
   ...
   *    deze branch; migratie 0203 zet er `goal_interviews_answers_len` op.
   *
