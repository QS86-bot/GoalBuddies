 ...
 *    los correct: de emmer heeft zijn policies (0239), de remmen tellen (0240),
 ...
 *    eigen_pad` (0241) paart `type = 'photo'` aan een beeldextensie en
...
describe.runIf(beschikbaar)('een bijlage is wat zijn soort zegt (0241)', () => {
  ...
  it('laat een document zónder bijlage naamloos', () => {
    ...
    //    onveranderlijk (`stamp_chat_message()`), dus de AVG-opruiming van 0242
    ...
    //    `doc`-rij zonder bijlage over. Zie §3 van 0241.
  ...
  it('geeft groepschat() de naam mee terug', () => {
    // ⚠️ Een kolom die de RPC niet doorgeeft, is een kolom die niemand ziet. 0241
  ...
  // -------------------------------------------------------------------------
  // De AVG-opruiming raakt béide emmers (0242)
  // -------------------------------------------------------------------------
  ...
  it('haalt bij een vertrekker de naam mee weg, niet alleen het pad', () => {
    ...
    //    zegt genoeg zonder dat er een byte van het bestand over is. 0242 zet
