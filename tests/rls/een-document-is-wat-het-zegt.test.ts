 ...
 *    los correct: de emmer heeft zijn policies (0237), de remmen tellen (0238),
 ...
 *    eigen_pad` (0239) paart `type = 'photo'` aan een beeldextensie en
...
describe.runIf(beschikbaar)('een bijlage is wat zijn soort zegt (0239)', () => {
  ...
  it('laat een document zónder bijlage naamloos', () => {
    ...
    //    onveranderlijk (`stamp_chat_message()`), dus de AVG-opruiming van 0240
    ...
    //    `doc`-rij zonder bijlage over. Zie §3 van 0239.
  ...
  it('geeft groepschat() de naam mee terug', () => {
    // ⚠️ Een kolom die de RPC niet doorgeeft, is een kolom die niemand ziet. 0239
  ...
  // -------------------------------------------------------------------------
  // De AVG-opruiming raakt béide emmers (0240)
  // -------------------------------------------------------------------------
  ...
  it('haalt bij een vertrekker de naam mee weg, niet alleen het pad', () => {
    ...
    //    zegt genoeg zonder dat er een byte van het bestand over is. 0240 zet
