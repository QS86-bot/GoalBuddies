 ...
 * QS8-548, migratie 0294.
 *
 * ⚠️⚠️ **Waarom die wrapper bestaat.** `0294` haalde `p_vandaag` van de functie
...
describe.skipIf(!beschikbaar)('de afgeschreven wrapper', () => {
   ...
   *    aanval waarvoor `0294` gemaakt is. Gaat iemand het lichaam kopiëren in
