/**
 * Te laat afronden laat de straf staan — QS8-322, migratie 0237.
 *
  ...
  describe('4. een afgerond doel gaat niet meer open', () => {
    it(
      ...
      async () => {
        ...
        // De achterdeur: `zet_doelstatus()` zette vóór 0237 §4 onvoorwaardelijk
  ...
  describe('3. een straf hoort bij een doel dat nog loopt', () => {
    it(
      ...
      async () => {
        ...
        expect(
          straf.error,
          'dit lukte vóór 0237 gewoon; met de completed-filter uit ' +
