...
/**
 * Elke tekstkolom die de client mag schrijven, heeft een lengtegrens — 0120.
 *
 ...
 */
describe.skipIf(!rlsTestsConfigured)('0120 — tekst zonder grens is opslag van een ander', () => {
