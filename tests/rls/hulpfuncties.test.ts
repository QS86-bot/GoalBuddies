...
describe.skipIf(!rlsTestsConfigured)('de vier RLS-hulpfuncties lopen gelijk', () => {
  ...
  it(
    ...
    async () => {
      ...
      //
      // ⚠️ **De eerste helft ging tot 0113 alleen over definer-functies, en dat
      ...
      //    veranderen. Sinds 0113 kijkt die tak naar élke functie in `public`;
      ...
      //    met een grant aan anon — allebei melden, en sinds 0113 ook een
