...
describe.skipIf(!rlsTestsConfigured)('de vier RLS-hulpfuncties lopen gelijk', () => {
  ...
  it(
    ...
    async () => {
      ...
      //
      // ⚠️ **De eerste helft ging tot 0112 alleen over definer-functies, en dat
      ...
      //    veranderen. Sinds 0112 kijkt die tak naar élke functie in `public`;
      ...
      //    met een grant aan anon — allebei melden, en sinds 0112 ook een
