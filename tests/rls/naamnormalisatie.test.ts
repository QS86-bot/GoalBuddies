...
describe.runIf(beschikbaar)('de twee talen halen in het midden dezelfde tekens weg', () => {
   ...
   *
   * ⚠️⚠️ **En sinds QS8-499 (migratie 0280) is dit niet langer een lijst maar
  ...
  it('is in ASCII-context de 3878 van 0271 plus de 363 van de contextregel', () => {
    ...
    //    met een naam eromheen. 📏 `Ja<ZWNJ>n` landde vóór 0280 als vier
    ...
    //    geen van beide raakt de contextregel van 0280 aan.
   ...
   *    reden was waar over de vórm en niet over de belofte; 0280 veranderde de
   ...
   *    gat dat dicht is. De grens van 0280 is *"tussen twee **ASCII**-
...
describe.runIf(beschikbaar)('de volgorde van de vijf stappen is zelf een naad', () => {
   ...
   *
   * 📏 **En dat feit is dragend, anders dan de kop van 0280 eerst beweerde.**
   ...
   *    randstap wél te zien. 📏 Vóór 0280 hield deze naam 11 codepunten over in
