 ...
 *    transactie constant. Migratie 0174 gaf de tabel daarom `seq`, een
...
describe('wie het auditspoor leest, sorteert op de volgordesleutel', () => {
  ...
  it('sorteert op seq en nergens op de klok', () => {
    ...
    expect(
      fout,
      `${TABEL} krijgt twee rijen per transactie en now() knoopt; sorteer op seq (migratie 0174, QS8-303)`,
    ).toEqual([]);
  });
});
