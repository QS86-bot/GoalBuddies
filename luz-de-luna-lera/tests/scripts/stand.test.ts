...
describe('standRegels', () => {
  ...
  it('noemt een lege map bij naam en verzint geen bereik', () => {
    const tekst = standRegels(['README.md']);
    expect(tekst).toContain('nog geen migraties');
    expect(tekst).not.toContain('0000');
  });
