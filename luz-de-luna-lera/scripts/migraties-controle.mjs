...
console.error(
  '\nDe migratiebestanden zijn de enige manier om dit schema ergens anders op te\n' +
    ...
    'dan toetst elke test daar een ander schema dan productie.\n\n' +
    ...
    'iets anders leunen. Dit beeld is zo oud als je laatste `git fetch`.\n\n' +
    ...
    'de hand: die laatste vergeet de kopregel.',
);
process.exit(1);
