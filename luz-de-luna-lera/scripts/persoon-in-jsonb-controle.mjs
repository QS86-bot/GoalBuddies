...
export const RECHTGEZET = [
  // ⚠️ Leeg tot de eerste vondst. Een regel heeft de vorm
  //   { bestand: '00NN_….sql', sleutel: 'approved_by', door: '00MM_….sql', waarom: '…' }
  //   en `door` moet de migratie noemen die de sleutel eruit haalde.
];
