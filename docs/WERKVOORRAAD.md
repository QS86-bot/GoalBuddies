...
4. ✅ **De RLS-suite draait sinds 24-08 lokaal** (QS8-119): `npm run rls:stack`
   ...
   **944 geslaagd, 1 overgeslagen** over 77 bestanden (04-09, na QS8-271, QS8-171 en QS8-146).
   ...
   suite geeft met de stack **3276 geslaagd en 1 overgeslagen** over
   233 bestanden.
...
Migraties `0001` t/m `0159` staan in de map: **162 bestanden**,
