...
**Database — af, en nu ook getest.** 34 tabellen. Migraties `0001` t/m `0115`
staan in de map.
...
⚠️ **`0115` staat wél op productie** — hij dicht een lek dat live was: `seizoensrecap_cijfers()` was voor elke ingelogde gebruiker aanroepbaar. Zie `docs/decisions/2026-08-28-revoke-from-public-is-niet-van-iedereen.md`.
