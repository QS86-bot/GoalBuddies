...
4. ✅ **De RLS-suite draait sinds 24-08 lokaal** (QS8-119): `npm run rls:stack`
   ...
   **857 geslaagd, 1 overgeslagen** (03-09, na QS8-213, QS8-208 en QS8-221). De
   hele suite geeft met de stack **2963 geslaagd en 1 overgeslagen** over 210 bestanden.
...
10. **⚠️ De volgorde loopt sinds 30-08 langs de doorloopbevindingen en niet meer
    ...
    plek in `shared/time`. Daarna QS8-200/QS8-201. Wat
...
Migraties `0001` t/m `0152` staan in de map: **155 bestanden**,
