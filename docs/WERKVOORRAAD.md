...
**Database — af, en nu ook getest.** 34 tabellen. Migraties `0001` t/m `0116`
staan in de map.
...
⚠️ **`0115` en `0116` staan wél op productie** — hij dicht een lek dat live was: `seizoensrecap_cijfers()` was voor elke ingelogde gebruiker aanroepbaar, en het venster van De Ketting stond op acht dagen bij een periode van zeven. Zie `docs/decisions/2026-08-28-revoke-from-public-is-niet-van-iedereen.md` en
