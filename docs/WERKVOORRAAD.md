...
4. ✅ **De RLS-suite draait sinds 24-08 lokaal** (QS8-119): `npm run rls:stack`
   ...
   **972 geslaagd, 1 overgeslagen** over 79 bestanden (05-09, na QS8-275, QS8-276, QS8-146, QS8-278, QS8-279, QS8-280, QS8-281, QS8-282 en QS8-199).
   ...
   suite geeft met de stack **3347 geslaagd en 1 overgeslagen** over
   239 bestanden.
   Typecheck, lint en alle 34 controlescripts groen;
