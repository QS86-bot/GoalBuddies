...
4. ✅ **De RLS-suite draait sinds 24-08 lokaal** (QS8-119): `npm run rls:stack`
   ...
   **451 geslaagd, 1 overgeslagen** (27-08, na QS8-137). Zonder credentials geeft
   `npm test` **998 geslaagd en 431 overgeslagen**; typecheck en lint groen.
...
**Database — af, en nu ook getest.** 31 tabellen. Migraties `0001` t/m `0100`
