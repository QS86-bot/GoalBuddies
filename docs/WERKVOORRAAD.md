...
**Het gat is daarmee achtentwintig bestanden** — `0222` t/m `0249`, van 09-09
en 10-09 en uit vijftien verschillende issues:
...
| `0248_een_document_volgt_dezelfde_weg_als_een_foto.sql` | QS8-408 | ja |
...
Migraties `0001` t/m `0249` staan in de map: **252 bestanden**,
