...
**Database — af, en nu ook getest.** 30 tabellen. Migraties `0001` t/m `0078`
...
| 14 | **EPIC 13 — Open of beschermde groepen** (QS8-132) | Besluit A41, 24-08. Varieert de gevoeligste policies die er zijn per groep, dus na alles wat erop leunt | 🚧 **fundering af, één oppervlak om** (24-08). Migraties 0076 (kolom, `group_events`, `zet_groepszichtbaarheid()`, twee systeemberichten), 0077 (`weekly_goals_select`) en 0078 (`best_streak` en `last_cycle_start`). Zeven oppervlakken staan bewust dicht; één is nog niet om: QS8-135 (De Ketting) |
