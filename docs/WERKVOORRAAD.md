...
| `0238_een_document_hoort_bij_een_groep.sql` | QS8-72 | ja |
| `0239_een_rem_op_documenten_per_groep_en_per_lid.sql` | QS8-72 | ja |
| `0240_een_bijlage_zegt_welke_soort_hij_is.sql` | QS8-72 | nee |
