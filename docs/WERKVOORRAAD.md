...
**Het gat is daarmee twintig bestanden** — `0222` t/m `0241`, van 09-09 en
...
| `0241_een_bijlage_zegt_welke_soort_hij_is.sql` | QS8-72 | nee |
| `0241_een_bijlage_overleeft_zijn_eigenaar_niet.sql` | QS8-72 | nee |
...
Migraties `0001` t/m `0241` staan in de map: **244 bestanden**,
