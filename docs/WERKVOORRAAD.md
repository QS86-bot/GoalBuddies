...
4. ✅ **De RLS-suite draait sinds 24-08 lokaal** (QS8-119): `npm run rls:stack`
   ...
   **804 geslaagd, 1 overgeslagen** (02-09, na QS8-186, QS8-262, QS8-264 en QS8-261). De
   hele suite geeft met de stack **2763 geslaagd en 1 overgeslagen** over 197 bestanden.
