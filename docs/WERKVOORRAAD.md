...
4. ✅ **De RLS-suite draait sinds 24-08 lokaal** (QS8-119): `npm run rls:stack`
   ...
   **399 geslaagd, 1 overgeslagen.** Zonder credentials geeft `npm test`
   **684 geslaagd en 379 overgeslagen**; typecheck en lint groen.
...
**Database — af, en nu ook getest.** 30 tabellen. Migraties `0001` t/m `0093`
...
- `npm run typecheck` en `lint` staan groen; `npm test` geeft zónder credentials
  **684 geslaagd en 379 overgeslagen** (die 379 zijn de RLS-suite, zie §3b)
