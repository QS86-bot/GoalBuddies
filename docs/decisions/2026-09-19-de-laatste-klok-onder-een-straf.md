...
**Datum:** 19-09-2026
**Issue:** QS8-548 · **Migratie:** `0294` · **Vervolg:** QS8-559
...
| `0294` | de verlooppoort in diezelfde functie | QS8-548 |
...
17-09-2026) terwijl de map op `0294` staat, en de gedeployde rollover is van
...
de eenargumentsvorm aan, dus het gat gaat dicht zodra `0294` op productie draait
...
📏 Gemeten met precies die opstelling: zonder `0294` `eerlijk=1 aanval=0`, met
`0294` `eerlijk=1 aanval=1`.
...
verwachtte **1**. Zodra `0294` de wrapper toevoegde werd dat **2**, en wees de
