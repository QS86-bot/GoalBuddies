...
| 33 | Een foto als bewijs bij een voltooiing | Niets. Bewijs is wat iemand zélf meestuurt bij een afronding — oppervlak 8 en niet 3 — en het publiek is dat van de voltooiing, die in beide standen gelijk is. ⚠️ Let op: `completions_select` heeft géén open-groepstak, terwijl `weekly_goals_select` die wél heeft. Dit oppervlak volgt de eerste, dus een open groep krijgt hier niets extra's. |
