...
**Datum:** 10-09-2026 · **Issue:** QS8-72 (PRD 7.4) · **Migraties:** 0238, 0239, 0240, 0241
...
tegen de tekst van 0238; wie er over een half jaar een vijfde emmer naast zet met
...
waar dit bestand staat**, en migratie 0240 is wat die twee gekoppeld houdt:
...
De eerste versie van 0240 eiste `type <> 'doc' or attachment_name is not null` —
een document draagt een naam. Dat botste met de AVG-opruiming van 0241:
...
`stamp_chat_message()` maakt `type` **onveranderlijk**, dus 0241 kon de rij niet
...
De functie dekt sinds 0241 `('chatfotos', 'chatdocs')`. De oude naam zou liegen
