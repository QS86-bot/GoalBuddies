...
**Datum:** 10-09-2026 · **Issue:** QS8-72 (PRD 7.4) · **Migraties:** 0240, 0241, 0242, 0243 · **Vervolg:** QS8-408 (0250)
...
- ~~**De opruimpas voor wezen in de emmer.**~~ ✅ **Gebouwd op 10-09 in QS8-408,
  migratie 0250** — zie §10. Wat hier stond ("zelfde grens als 0224 en 0230: SQL
...
## 10. Nagekomen: het document volgt alsnog dezelfde weg — QS8-408, migratie 0250
...
0250 haalt de oorzaak weg, en dan mag de rest mee:
