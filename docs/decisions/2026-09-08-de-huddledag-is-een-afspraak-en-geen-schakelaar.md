...
**Datum:** 08-09-2026 · **Issue:** QS8-360 · **Migratie:** 0208
...
enige weg is. 0208 is diezelfde vorm, één laag hoger.
...
herberekend.** Wat 0208 verhuist is uitsluitend de periode die op dat moment
loopt — en dat is geen geschiedenis: hij is nog niet afgelopen, en zijn start
ís de afspraak die verzet wordt.

Diezelfde grens loopt door in `group_overview()`. De derde eis die 0208 aan de
...
antwoord over een periode die niet bestaat, en dat is lelijk. De kop van 0208
