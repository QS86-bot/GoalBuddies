...
**Datum:** 08-09-2026 · **Issue:** QS8-360 · **Migratie:** 0209
...
enige weg is. 0209 is diezelfde vorm, één laag hoger.
...
herberekend.** Wat 0209 verhuist is uitsluitend de periode die op dat moment
loopt — en dat is geen geschiedenis: hij is nog niet afgelopen, en zijn start
ís de afspraak die verzet wordt.

Diezelfde grens loopt door in `group_overview()`. De derde eis die 0209 aan de
...
antwoord over een periode die niet bestaat, en dat is lelijk. De kop van 0209
