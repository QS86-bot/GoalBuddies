 ...
 *
 * ⚠️ Zo dun met opzet: de knop staat in `shared/ui` en het werk in
 *    `useAvatarKeuze()`. Dit stukje mag in twee schermen staan omdat er niets in
 *    zit dat uit elkaar kan lopen.
 */
