...
describe('domeinregel 7: falen is nooit publiek', () => {
  ...
  it('bevat uitsluitend de veertien gebeurtenissen van 0025, 0032, 0070, 0076, 0112, 0144 en 0208', () => {
    ...
    expect([...SYSTEEM_GEBEURTENISSEN]).toEqual([
      ...
      'season_recap',
      // ⚠️ QS8-360 (migratie 0208). Gaat over de gróép — de huddledag is verzet —
      ...
      //    afgesloten. Het bericht draagt het daarom niet.
      'huddle_day_changed',
    ]);
  });
...
describe('soortBijlage', () => {
  ...
  it('wijst een documentbericht naar de document-emmer', () => {
    ...
    //    afgeleid, en migratie 0237 is wat de soort aan de extensie gepaard
    //    houdt.
