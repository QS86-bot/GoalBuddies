...
describe('domeinregel 7: falen is nooit publiek', () => {
  ...
  it('bevat uitsluitend de veertien gebeurtenissen van 0025, 0032, 0070, 0076, 0112, 0144 en 0209', () => {
    ...
    expect([...SYSTEEM_GEBEURTENISSEN]).toEqual([
      ...
      'season_recap',
      // ⚠️ QS8-360 (migratie 0209). Gaat over de gróép — de huddledag is verzet —
