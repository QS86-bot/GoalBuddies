...
function meldingen(): Readonly<Record<string, string>> {
  return {
    ...
    // zet_huddledag (QS8-360, migratie 0207)
    //
...
/**
 * Verzet de huddledag van een groep — QS8-360, migratie 0207.
 *
 * ⚠️ **Waarom dit geen kolom in `wijzigGroep()` meer is.** De huddledag bepaalt
 *    waar de groepsperiode begint. 📏 Gemeten vóór 0207: na een kale PATCH kon
