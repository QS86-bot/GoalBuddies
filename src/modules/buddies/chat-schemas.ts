...
export interface ChatBericht {
  ...
  /**
   * De oorspronkelijke bestandsnaam van een document — QS8-72, migratie 0241.
   *
   ...
   *    ligt vast in de CHECK van 0241. Zo kunnen naam en soort nooit misleidend
 ...
 *    0241 is wat die twee gekoppeld houdt: de extensie is aan de soort gepaard,
