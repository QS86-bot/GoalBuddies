...
function bouwPlanPrompt(input: Record<string, unknown>, locale: string | null): string {
  ...
  return [
    ...
    '  (zelfzorg, slaap, herstel), "mindfulness" (meditatie, rust en aandacht),',
    '  "creativity" (maken en scheppen), "productivity" (meer gedaan krijgen),',
    '  "connection" (sociaal contact), "business" (werk en ondernemen),',
    '  "study" (school en studie), "building" (iets bouwen of opzetten),',
    '  "skills" (een vaardigheid oefenen). Past er echt geen: "other".',
