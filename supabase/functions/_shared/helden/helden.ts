 ...
 *
 * ⚠️⚠️ **Dit bestand heeft geen enkele import, en dat is sinds QS8-475 een eis
 *    en geen toeval.** `npm run edge:sync` neemt het mee naar Deno, want de
 *    meldingenjob kiest daar welke held spreekt. Alles wat een import meebrengt
 *    — de catalogussleutels voorop — staat daarom in `heldteksten.ts` ernaast.
 *    Het register is data; wat je met die data in de app doet, is een laag
 *    erboven.
 *
