-- 0098 — Een vertrek is een handeling en geen DELETE (QS8-57, PRD 5.6)
--
...
comment on function public.shares_group_with_goal(uuid) is
  ...
  'actief lid van is? ⚠️ De eigenaarshelft en de archieftoets zijn er in 0098 '
...
comment on column public.group_events.subject_id is
  ...
  'actor — vandaag alleen de nieuwe beheerder bij admin_transferred (0098). '
