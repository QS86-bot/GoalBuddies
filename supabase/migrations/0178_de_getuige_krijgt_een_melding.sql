-- 0178_de_getuige_krijgt_een_melding.sql — de persoon-getuige van een straf hoorde pas dat hij getuige was als hij de app zelf opende (QS8-298)
--
-- ROLLBACK-PAD:
...
comment on function public.getuigenissen_voor(uuid) is
  ...
  'maar krijgt de gebruiker als argument. Zie 0178 en QS8-298.';
