-- 0275_een_dagplafond_op_blokkades_dat_niemand_raakt_die_misbruik_ontvlucht.sql
...
comment on function public.blokkades_plafond() is
  ...
  'die twee dagbudgetten, niet de leden- of groepsplafonds. Zie 0275 en '
  'QS8-496.';
...
AS $function$
  with sleutel(instelling, toegestaan) as (
    values
      ...
      -- ⚠️ Uit 0275 (QS8-496). De achttiende dagteller krijgt zijn rem, en dus
