-- 0120_tekst_zonder_grens_is_opslag_van_een_ander.sql — veertien lengtegrenzen
...
comment on function public.ai_invoer_max() is
  ...
  'formulier maximaal kan opleveren; zie 0120.';
...
begin
  ...
  -- -------------------------------------------------------------------------
  -- ⚠️ De bovengrens op de invoer — 0120
  -- -------------------------------------------------------------------------
  --
  -- Tien jobs per dag is pas een quotum als één job begrensd is. Tot 0120 stond
