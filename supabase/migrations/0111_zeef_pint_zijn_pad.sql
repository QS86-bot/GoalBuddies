-- 0111_zeef_pint_zijn_pad.sql — drie functies zonder search_path, en de zeef die daardoor niets zeeft
--
-- ROLLBACK-PAD:
...
as $$
  ...
  --    0111.** Een functie zonder gepind pad hoeft geen rechten te verhogen om
