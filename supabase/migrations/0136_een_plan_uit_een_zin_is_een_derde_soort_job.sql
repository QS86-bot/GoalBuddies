-- 0136_een_plan_uit_een_zin_is_een_derde_soort_job.sql — ai_jobs.kind krijgt 'plan'
--
-- ROLLBACK-PAD:
...
comment on column public.ai_jobs.goal_id is
  'Het doel waar deze job bij hoort. ⚠️ NULL bij kind = ''plan'' (0136): daar '
...
comment on function public.vraag_ai_job(text, uuid, jsonb) is
  ...
  'soorten sinds 0136: milestones, weekly_goals, milestone_tip en plan. Een '
