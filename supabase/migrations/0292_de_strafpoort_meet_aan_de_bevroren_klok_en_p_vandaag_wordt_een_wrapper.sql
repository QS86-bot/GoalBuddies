-- 0292_de_strafpoort_meet_aan_de_bevroren_klok_en_p_vandaag_wordt_een_wrapper.sql
...
--    **0282** staat (gemeten 17-09-2026), terwijl de map op `0292` staat. De
...
comment on function public.maak_straffen_verschuldigd(uuid, date) is
  'Afgeschreven sinds 0292 (QS8-548): negeert p_vandaag en roept '
